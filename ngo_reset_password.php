...
if (isset($_GET['code'])) {
    ...
    $query = "SELECT * FROM ngo WHERE reset_code = ?";
...
if (isset($_POST['update_password'])) {
    ...
    if ($password !== $confirm_password) {
        ...
        $update_query = "UPDATE ngo SET password = ?, reset_code = NULL WHERE email = ?";
        ...
        if ($update_query_run) {
            ...
            $success_message = "Password updated successfully. You can now <a href='ngo_login.php'>login</a> with your new password.";
            $cls = 'success';
    ...
    <main class="form-signin">
        <form action="" method="POST">
            ...
            <div class="mb-3">
                ...
                <p><?php echo htmlspecialchars($_SESSION['reset_email']); ?></p>
            </div>
            <?php endif; ?>
