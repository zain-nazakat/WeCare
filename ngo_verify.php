...
if (isset($_GET['code'])) {
    ...
    $query = "SELECT * FROM ngo WHERE code = '$code'";
    ...
    if ($query_run && mysqli_num_rows($query_run) > 0) {
        ...
        $update_query = "UPDATE ngo SET is_verified = 1 WHERE code = '$code'";
        ...
        if ($update_run) {
            ...
            echo "<p style='text-align: center;'>You can now <a href='ngo_login.php'>login here</a>.</p>";
        } else {
