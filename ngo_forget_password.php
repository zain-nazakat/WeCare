...
if (isset($_POST['reset_password'])) {
    ...
    if ($query_run && mysqli_num_rows($query_run) == 1) {
        ...
        $update_query = "UPDATE ngo SET reset_code = '$reset_code' WHERE email = '$email'";
        ...
        if ($update_query_run) {
            ...
            try {
                ...
                $mail->Body = "Hello $username,<br>Click <a href='http://localhost/wecare/ngo_reset_password.php?code=$reset_code'>here</a> to reset your password.";
...
<body class="text-center">
    ...
    <main class="form-signin">
        <form action="" method="POST">
            <h1 class="h3 mb-5 fw-normal" style="font-weight:700">NGO Forgot Password</h1>
            <?php if (!empty($error)): ?>
            ...
            <p class="mt-5 mb-3 text-muted">Remembered your password? Sign In <a href="ngo_login.php">Now</a></p>
        </form>
    </main>
