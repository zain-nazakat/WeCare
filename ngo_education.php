...
<body>
    ...
    <section class="d-flex">
        <div class="header d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 280px;">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li>
                    <a href="ngo_education.php" class="nav-link active" aria-current="page"
    ...
    <div class="row d-flex justify-content-between">
        ...
        <div class="row mt-4">
            <div class="col-md-12">
                <form action="process_education.php" method="POST" enctype="multipart/form-data">
                    <!-- Heading Input -->
                    <div class="mb-3">
                        <label for="heading" class="form-label">Heading</label>
                        <input type="text" class="form-control" id="heading" name="heading" placeholder="Enter the heading" required>
                    </div>
                    ...
                    <a href="ngo_education_data.php" class="btn btn-secondary">cancel</a>
                </form>
            </div>
        </div>
    </div>
