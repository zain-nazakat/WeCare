...
if ($row22) {
    ...
    $ngo_read = 1; // Or any default value indicating no new messages
}
?>
...
<td>
    <button type="button" 
            ...
            style="font-size:12px;padding:10% 20%;margin-right:10%" 
            data-bs-toggle="modal" 
            data-bs-target="#messageModal" 
            onclick="showNumber('<?php echo $poster_id; ?>')">
        Message
    </button>
</td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="messageModalLabel">Contact Number</h5>
...
<!-- JavaScript -->
<script>
    function showNumber(posterId) {
        // Replace with real number fetching logic if required
        const dummyNumber = "+92 3139316038"; // Example number
        document.getElementById('displayNumber').textContent = `Poster ID: ${posterId}, Number: ${dummyNumber}`;
    }
</script>
