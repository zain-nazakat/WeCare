            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 " style="padding-left:15%">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="About_us.html">Why WeCare</a> 
        ...
        <div class="container col-xxl-9 px-4 py-5">
            <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
                ...
                <div class="col-lg-7">
                    ...
                    <p class="lead">Welcome to WeCare, the website dedicated to providing food, clothing, and medicine
                        to those in need. Our mission is to help the less
            ...
            <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
                <div class="col-lg-7">
                    <h4>Do you want to make a difference in the lives of those facing food insecurity? Look no further
                        ...
                        <p>
                            WeCare is a website dedicated to helping those in need by providing food, clothing, and
                            ...
                            At WeCare, we understand that food insecurity affects many people in our society, and we
                ...
                <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
                    <div class="col d-flex align-items-start">
                        <div>
                            ...
                            <a href="donner_signup.php" class="btn btn-orange">
                                Donate
                            </a>
                        </div>
                    </div>
