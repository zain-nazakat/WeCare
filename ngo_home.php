    ...
    <section class="d-flex">
        <div class="header d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 280px;">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li>
                    <a href="ngo_education_data.php" class="nav-link text-white" style="font-size:17px;">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="card mx-auto"
                        ...
                        <h5 class="card-title" style="font-family:poppins;color:black;font-size:18px">Volunteer Posts
                        </h5>
                ...
                <div class="col-md-3">
                    <div class="card mx-auto"
                        style="text-align:center;padding:20px 0px;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2); height:12rem;">
                        <h5 class="card-title" style="font-family:poppins;color:black;font-size:20px">Donation Completed</h5>
